...
import (
	...
	mockdb "github.com/Nithish-Sri-Ram/simplebank/db/mock"
...
func TestGetAccountAPI(t *testing.T) {
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			defer ctrl.Finish() // This is used to check to see if all methods that were expected to be called were called
